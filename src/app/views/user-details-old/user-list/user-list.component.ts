...
@Component({
  ...
  standalone: true,
  imports: [NgbRatingModule, CalendarModule, MatIconModule, MatFormFieldModule, NgSwitch, NgSwitchCase, FormsModule, CdkDropList, CdkDrag, MatSlideToggleModule, RouterModule, NgFor,MatSelectModule, MatMenuModule,NgIf],
})
export class UserListComponent {
  ...
  private performancerelatedchart() {
    ...
    this.chart = new Chart('performance', {
      type: 'bar',  
      data: {
        labels: ['On Track', 'Before Time', 'Delayed'],
        datasets: [{
          data: [
            this.memberdata.totalPerformanceOnTrack,
            this.memberdata.totalPerformanceBeforeTime,
            this.memberdata.totalPerformanceDelayed
          ],
          barThickness: 20,
          maxBarThickness: 100,
          backgroundColor: [
